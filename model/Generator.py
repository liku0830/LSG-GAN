...
from GlobalEncoder import GlobalFlow
from SourceInputEncoder_I import ImageEncoder
from FMB import FMB
from SourceInputEncoder_P import PoseFlow
...
class MainFlow(nn.Module):
    ...
    def forward(self, x, m, p1, p2):
        img = x
        x = self.g_flow(x, p1, p2)
        i_1_2, i_1_4, i_1_8 = self.i_flow(img)
        p_1_2, p_1_4, p_1_8 = self.p_flow(p2)
        t_1_2, t_1_4, t_1_8, t_out = self.FMB_flow(i_1_8, m, p_1_8)          # t_out is guided by template ground truth
