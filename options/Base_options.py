...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        g_train.add_argument('--template_dir', help='the directory of template',type=str, default='./datasets/tem/')

        g_train.add_argument('--save_pic_root', help='root of save picture', type=str,default='./')
        g_train.add_argument('--save_modelG_root', help='root of save generator model', type=str,default='./netG/')
        g_train.add_argument('--save_modelD_root', help='root of save discriminator model', type=str,default='./netD/')


        g_train.add_argument('--pretrain_netG', help='the directory of template', type=str,default='')
        g_train.add_argument('--pretrain_netD', help='the directory of template', type=str,default='')
